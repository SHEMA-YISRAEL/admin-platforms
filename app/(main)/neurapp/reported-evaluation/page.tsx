...
import QuestionReportsTable from '@/components/neurapp/QuestionReportsTable';
import useQuestionReports, { ReportFilter } from '@/app/hooks/neurapp/useQuestionReports';

const NeurappReportedPage: React.FC = () => {
  const [filter, setFilter] = useState<ReportFilter>('pending');
  const { reports, loading, setReports } = useQuestionReports(filter);
...
export default NeurappReportedPage;
