import ActiveUsersCard from '@/components/topoquizz/ActiveUsersCard';
import RegisteredUsersCard from '@/components/topoquizz/RegisteredUsersCard';
    ...
    return (
        <div className="h-screen flex flex-col">
            ...
            <div className="flex-1 grid grid-cols-2 grid-rows-2 gap-4 p-4">
                <div className="bg-blue-100 border-2 border-blue-300 rounded-lg">
                    <ActiveUsersCard />
                </div>
                <div className="bg-green-100 border-2 border-green-300 rounded-lg">
                    <RegisteredUsersCard />
                </div>
