...
interface ISubjectListProps {
  ...
  methodSetSelectedSubject: Dispatch<SetStateAction<ICoursesData | undefined>>;
...
const SubjectsList: React.FC<ISubjectListProps> = ({ selectedSubject, methodSetSelectedSubject }) => {
  ...
  useEffect(() => {
    ...
    if (coursesDataFromFirebase.length > 0) {
      ...
      setSelected(coursesDataFromFirebase[0])
    }
...
const ContentPage: React.FC<ContentPageProps> = () => {
  ...
  const [lessonIdSelected, setLessonIdSelected] = useState('');
