...
const rolePermissions: Record<UserRole, string[]> = {
  ...
  admin: [
    ...
    '/topoquizz/translate',
    '/topoquizz/reported',
    '/topoquizz/reported-evaluation',
    '/neurapp/reported-evaluation',
    '/neurapp/reported-clinical-cases',
    '/neurapp',
  ],
...
export function proxy(request: NextRequest) {
  ...
  if (
    !hasAccess &&
    (pathname.startsWith('/topoquizz') || pathname.startsWith('/neurapp'))
  ) {
...
export const config = {
  matcher: ['/', '/topoquizz/:path*', '/neurapp/:path*'],
};
